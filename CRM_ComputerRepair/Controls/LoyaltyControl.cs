...
namespace CRM.winforms
{
    ...
    public class LoyaltyControl : UserControl
    {
        ...
        private void BuildUi()
        {
            ...
            {
                Text = "Reward programs for your customers",
            ...
            btnAdd = new FlatButton("Add program", "\uE710");
        ...
        public async Task ReloadAsync()
        {
            try
            {
                ...
                lblCount.Text = $"{_all.Count} {(_all.Count == 1 ? "program" : "programs")}";
                ...
                {
                    dgv.Visible = false;
                    state.Show("\uE8C7", "No loyalty programs yet",
                        "Use Add program to create your first reward program.");
                }
            }
            catch (Exception ex)
            {
                MessageBox.Show($"Couldn't load loyalty programs.\n\n{ex.Message}",
